    ...
    function EntityManager(){
        ...
        return {
            ...
            createModelAttributesNode: function(){
                if(_modelAttributesNode === null) return new ModelAttributesNode("modelAttributes",metamodel.attributes);
                return null;
            },
            /**
             * Find node by id
                                ...
                                for(j = 0, numOfTargetTypes = targetNodeTypes.length; j < numOfTargetTypes; j++){
                                    ...
                                    for(targetNodeId in targetNodes){
                                        if(targetNodes.hasOwnProperty(targetNodeId)){
                                            ...
                                            if(targetNode === node || targetNode.getNeighbors().hasOwnProperty(node.getEntityId())) continue;
