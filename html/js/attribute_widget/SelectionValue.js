define([
...
],/** @lends SelectionValue */function($,jsPlumb,_,IWCW,AbstractValue,ValueChangeOperation,selectionValueHtml) {
    ...
    function SelectionValue(id,name,subjectEntity,rootSubjectEntity,options){
         ...
         * @private
         */
        var _$node = $(_.template(selectionValueHtml,{name: name, options: options}));
