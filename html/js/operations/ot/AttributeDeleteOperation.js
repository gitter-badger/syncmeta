define([
     ...
     * @constructor
     */
    function AttributeDeleteOperation(entityId,subjectEntityId,rootSubjectEntityId,type){
        var that = this;

        EntityOperation.call(this,EntityOperation.TYPES.AttributeDeleteOperation,entityId,CONFIG.ENTITY.ATTR);
