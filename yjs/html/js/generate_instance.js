                ...
                .then(function(metamodel/*, logicalGuidanceRepresentation*/){
                    return createSpace(spaceLabel,spaceTitle)
                        .then(function(spaceURI){
                            return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/activity.xml")
                                .then(function(){
                                    return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/widget.xml");
                                }).then(function(){
                                    return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/palette.xml");
                                }).then(function(){
                                    return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/attribute.xml");
                                }).then(function(){
                                    return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/debug.xml");
                                }).then(function(){
                                    var deferred = $.Deferred();
                                ...
                                .then(function(){
                                    return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/viewcontrol.xml");
                                }).then(function(){
                                    return addWidgetToSpace(spaceURI,"http://rwth-acis.github.io/syncmeta/yjs/html/heatmap.xml");
                                })/*.then(function(){
